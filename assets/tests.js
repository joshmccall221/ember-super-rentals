...
define('super-rentals/tests/acceptance/list-rentals-test', ['qunit', 'super-rentals/tests/helpers/module-for-acceptance', 'ember'], function (_qunit, _moduleForAcceptance, _ember) {
  'use strict';
...
define('super-rentals/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'ember', 'super-rentals/tests/helpers/start-app', 'super-rentals/tests/helpers/destroy-app'], function (exports, _qunit, _ember, _startApp, _destroyApp) {
  'use strict';
...
define('super-rentals/tests/helpers/start-app', ['exports', 'ember', 'super-rentals/app', 'super-rentals/config/environment'], function (exports, _ember, _app, _environment) {
  'use strict';
...
define('super-rentals/tests/integration/components/rental-listing-test', ['ember-qunit', 'ember'], function (_emberQunit, _ember) {
  'use strict';
